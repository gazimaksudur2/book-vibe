...
const ListedBookCard = ({ book, myStatus }) => {
    ...
    return (
        <div className='w-full'>
            <div className="w-full p-4 md:p-8 bg-base-100 shadow-xl flex flex-col md:flex-row items-center gap-8 md:gap-16 rounded-2xl">
                ...
                <div className="info space-y-3 w-full">
                    ...
                    <div className="tags flex justify-start md:inline items-center">
                        ...
                        {
                            tags.map((tag, idx) => <span key={idx} className='text-[#23BE0A] mr-4 text-lg font-medium'>#{tag}</span>)
                        }
                    </div>
