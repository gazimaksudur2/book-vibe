...
const Footer = () => {
    return (
        <div>
            <footer className="footer items-center p-4 bg-neutral text-neutral-content gap-2">
                <aside className="items-center md:justify-start justify-center w-full grid-flow-col">
                ...
                <nav className="items-center md:justify-end justify-center w-full grid-flow-col gap-4 md:place-self-center md:justify-self-end">
